...
| P1 | wip | Split `routes/projects.py` into services (images, attachments, steps, importing, categories) and make endpoints thin | High | High | `stricknani/routes/projects.py`, `stricknani/services/projects/*` |
