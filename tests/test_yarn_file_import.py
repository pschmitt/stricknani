...
import pytest
from stricknani.importing.models import ExtractedData, ExtractedYarn

@pytest.mark.asyncio
async def test_import_yarn_from_file_with_ai(test_client):
    ...
    with patch("stricknani.importing.extractors.ai.OPENAI_AVAILABLE", True), \
...
@pytest.mark.asyncio
async def test_import_yarn_from_text_with_ai(test_client):
