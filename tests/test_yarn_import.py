...
async def test_import_yarn_wolle_roedel(test_client) -> None:
    ...
    <html>
        ...
        <body>
            ...
            <div class="product-info">
                ...
                <p>Creative Melange Alpaca Wonderball DK ist die Alpaka-Variante zu dem Garn Creative Melange Alpaca Wonderball Aran.</p>
                <ul>
    ...
    assert data["name"] == "Creative Melange Alpaca Wonderball dk | Autumn | 3725351"
