...
const adminToastMessages = {
	admin_granted: {
		message: "{{ _("Admin access granted") }}",
		variant: "success",
	},
	admin_revoked: {
		message: "{{ _("Admin access revoked") }}",
		variant: "success",
	},
	user_activated: {
	...
	cannot_remove_last_admin: {
		message: "{{ _("Cannot remove the last admin") }}",
		variant: "error",
	},
	cannot_remove_own_admin: {
		message: "{{ _("Cannot remove your own admin access") }}",
		variant: "error",
	},
	...
	cannot_delete_last_admin: {
		message: "{{ _("Cannot delete the last admin") }}",
		variant: "error",
	},
