...
class AIExtractor(ContentExtractor):
    ...
    def _build_system_prompt(self) -> str:
        ...
        return (
            ...
            "IMPORTANT: Do not drop or omit any provided text. If you find "
            "information that doesn't clearly fit into one of the specific "
            "fields, add it to the 'description' field instead of omitting it.\n\n"
            "Fields to extract:\n"
