...
fun SettingsCategoryScreen(
    ...
    when (category) {
        ...
        SettingsCategory.Appearance -> AppearanceSettingsScreen(onBack = onBack, viewModel = viewModel)
        SettingsCategory.Navigation -> NavigationSettingsScreen(onBack = onBack, viewModel = viewModel)
