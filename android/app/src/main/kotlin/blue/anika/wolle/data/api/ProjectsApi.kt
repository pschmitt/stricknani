 ...
 * (queued through `PendingMutationDao`/`sync/WriteReplayWorker.kt` - SNA-8). Steps/images
 * /attachments upload endpoints are a later follow-up (multipart, deferred - see `android/TODO.md`
 * SNA-10).
 */
